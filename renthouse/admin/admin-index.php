...
<body>
 ...
 <div class="container-fluid">
  <ul class="nav nav-pills nav-justified">
    <li class="active" style="background-color: #FFF8DC"><a data-toggle="pill" href="#home"><b>Property Lists</b></a></li>
    <li style="background-color: #FAF0E6"><a data-toggle="pill" href="#menu1"><b>Owners Details</b></a></li>
    <li style="background-color: #FFFACD"><a data-toggle="pill" href="#menu2"><b>Tenant Details</b></a></li>
    <li style="background-color: #FAFACD"><a data-toggle="pill" href="#menu3"><b>Booked Property</b></a></li>
  </ul>
  <div class="tab-content">
    <div id="home" class="tab-pane fade in active">
      <center><h3><b>Property Lists</b></h3></center>
      <div class="container-fluid">
...
<?php $sql2="SELECT * from property_photo where property_id='$property_id'";
    ...
    <div id="menu1" class="tab-pane fade">
      <center><h3><b>Owner Details</b></h3></center>
      <div class="container-fluid">
    ...
    <div id="menu2" class="tab-pane fade">
      <center><h3><b>Tenant Details</b></h3></center>
      <div class="container">
